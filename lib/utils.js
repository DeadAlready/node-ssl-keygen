 ...
 * 
 * @param {Function} errorCallback callback used upon error
 * @param {Function} [callback] callback used when no error
 */
 ...
 * Function for wraping callback to handle errors
 * 
 * @param {Function} scope scope to bind the clearCallback
 */
function wrapCleanCallback(scope){
  return cleanCallback.bind(scope);
}
...
module.exports = {
  ...
  wrapCleanCallback: wrapCleanCallback,
  cC: cleanCallback
}